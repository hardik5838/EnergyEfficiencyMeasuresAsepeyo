...
if not df.empty:
  ...
  # --- Initialize Session State and Define Functions ---

    # This must be at the top of the script's logic
    ...
    with st.sidebar:
        ...
        if selected_communities:
            ...
            # This check handles the case where a user changes community selection,
            # making the previously selected centers in session_state invalid.
    ...
    # --- Process and Filter Data AFTER Collecting Inputs ---
    
    # 1. Apply categorization based on the selected analysis type
    ...
    # 2. Filter the categorized dataframe based on the sidebar selections
    if selected_communities:
